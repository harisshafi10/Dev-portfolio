...
const Experience = () => {
  return (
    <div className='flex items-center w-370 h-191 flex-col gap-100'>
        <div className='flex items-center w-170 h-130 flex-col gap-20 p-4'>
      ...
      <div className=' flex items-center gap-2 w-170 '>
        ...
        <span className='flex items-center ml-49 text-sm text-gray-500'>Nov 2026 - Present</span>
      </div>
      ...
      <div className=' flex items-center gap-2 w-170'>
        ...
        <span className='flex items-center ml-66 text-sm text-gray-500'>Nov 2026 - Present</span>
      </div>
